...
- For game wiki template or child-site launch work, follow `docs/GAME_SITE_COURSE.md` and `docs/GAME_SITE_LAUNCH_CHECKLIST.md`. These docs translate the local course PDFs into project operating rules. If they conflict with this file, this file wins.
- Do not move, delete, rename, or commit the course PDFs listed in `docs/COURSE_SOURCE_FILES.md` unless the user explicitly asks for that exact file operation.
