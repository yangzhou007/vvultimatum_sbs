...
- For game wiki template or child-site launch work, follow `docs/GAME_SITE_COURSE.md`, `docs/GAME_SITE_SOP.md`, and `docs/GAME_SITE_LAUNCH_CHECKLIST.md`. These docs translate the local course HTML files into project operating rules. If they conflict with this file, this file wins.
