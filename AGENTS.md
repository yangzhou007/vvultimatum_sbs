...
- Use the course HTML files listed in `docs/COURSE_SOURCE_FILES.md` as the course source of truth. Do not use the old PDF course exports as reference unless the user explicitly asks to inspect a PDF.
