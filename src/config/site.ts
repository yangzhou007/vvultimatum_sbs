...
export const SITE_CONFIG = {
  ...
  ignoredContentSlugFragments: ["vv-ultimatum", "gelum"],
  footerGuideLinks: {
    beginnerGuide: "/guide",
    raceGuides: "/races",
    bossGuides: "/bosses",
  ...
  legalPages: {
    ...
    contact: {
      title: "Contact",
      paragraphs: [
        "Use this page for site owner contact details, correction requests, and rights-owner review requests.",
        "Child sites should set a real contact email before launch so players, advertisers, and rights owners can reach the operator.",
      ],
    },
  },
} as const;
